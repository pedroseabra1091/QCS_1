...
{	int j, h = now._nr_pr;
	...
	case 1:	/* Voter */
		...
		/* locals: */
		((P1 *)pptr(h))->_3_ret =  -(1);
		((P1 *)pptr(h))->_3_ret_occur = 0;
		((P1 *)pptr(h))->_3_valid = 0;
		((P1 *)pptr(h))->_3_best_value =  -(1);
		((P1 *)pptr(h))->_3_best_occur = 0;
		((P1 *)pptr(h))->_3_nresults = 0;
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			((P1 *)pptr(h))->_3_real_results[0].a[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			((P1 *)pptr(h))->_3_real_results[1].a[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			((P1 *)pptr(h))->_3_real_results[2].a[l_in] = 0;
		}
	}
		((P1 *)pptr(h))->_3_exists = 0;
		((P1 *)pptr(h))->_3_i = 0;
		((P1 *)pptr(h))->_3_j = 0;
#ifdef VAR_RANGES
		logval("Voter:valid", ((P1 *)pptr(h))->_3_valid);
		logval("Voter:exists", ((P1 *)pptr(h))->_3_exists);
		logval("Voter:i", ((P1 *)pptr(h))->_3_i);
		logval("Voter:j", ((P1 *)pptr(h))->_3_j);
		logval("Voter:ret_occur", ((P1 *)pptr(h))->_3_ret_occur);
		logval("Voter:best_occur", ((P1 *)pptr(h))->_3_best_occur);
		logval("Voter:nresults", ((P1 *)pptr(h))->_3_nresults);
		logval("Voter:ret", ((P1 *)pptr(h))->_3_ret);
		logval("Voter:best_value", ((P1 *)pptr(h))->_3_best_value);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("Voter:_3_real_results[0].a[l_in]", ((P1 *)pptr(h))->_3_real_results[0].a[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("Voter:_3_real_results[1].a[l_in]", ((P1 *)pptr(h))->_3_real_results[1].a[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("Voter:_3_real_results[2].a[l_in]", ((P1 *)pptr(h))->_3_real_results[2].a[l_in]);
		}
	}
#endif
#ifdef HAS_CODE
	...
	case 0:	/* webServer */
		...
		reached0[12]=1;
		/* params: */
		((P0 *)pptr(h))->wsinstance = par0;
		/* locals: */
		((P0 *)pptr(h))->_2_wsresult =  -(1);
#ifdef VAR_RANGES
		logval("webServer:wsinstance", ((P0 *)pptr(h))->wsinstance);
		logval("webServer:wsresult", ((P0 *)pptr(h))->_2_wsresult);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
iniglobals(void)
{
	...
	{	int l_in;
		for (l_in = 0; l_in < 3; l_in++)
		{
			logval("res_possiveis[l_in]", now.res_possiveis[l_in]);
		}
	}
#endif
...
{	/* int i; */
	...
	{	int l_in;
		for (l_in = 0; l_in < 3; l_in++)
		{
			printf("	int    res_possiveis[%d]:	%d\n", l_in, now.res_possiveis[l_in]);
		}
	}
}
void
...
{	/* int i; */
	switch(tp) {
	case 1:
		printf("local vars proc %d (Voter):\n", pid);
	printf("	int    ret:	%d\n", ((P1 *)pptr(pid))->_3_ret);
	printf("	short  ret_occur:	%d\n", ((P1 *)pptr(pid))->_3_ret_occur);
	printf("	bit    valid:	%d\n", ((P1 *)pptr(pid))->_3_valid);
	printf("	int    best_value:	%d\n", ((P1 *)pptr(pid))->_3_best_value);
	printf("	short  best_occur:	%d\n", ((P1 *)pptr(pid))->_3_best_occur);
	printf("	short  nresults:	%d\n", ((P1 *)pptr(pid))->_3_nresults);
		printf("	(struct _3_real_results)\n");
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    a[%d]:	%d\n", l_in, ((P1 *)pptr(pid))->_3_real_results[ 0 ].a[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    a[%d]:	%d\n", l_in, ((P1 *)pptr(pid))->_3_real_results[ 1 ].a[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    a[%d]:	%d\n", l_in, ((P1 *)pptr(pid))->_3_real_results[ 2 ].a[l_in]);
		}
	}
	printf("	bit    exists:	%d\n", ((P1 *)pptr(pid))->_3_exists);
	printf("	byte   i:	%d\n", ((P1 *)pptr(pid))->_3_i);
	printf("	byte   j:	%d\n", ((P1 *)pptr(pid))->_3_j);
		break;
	case 0:
		printf("local vars proc %d (webServer):\n", pid);
	printf("	int    wsinstance:	%d\n", ((P0 *)pptr(pid))->wsinstance);
	printf("	int    wsresult:	%d\n", ((P0 *)pptr(pid))->_2_wsresult);
		break;
	}
}
void
